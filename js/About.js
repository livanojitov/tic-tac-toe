const About = () => {
  ...
  const [about] = useState([
    ...
    { name: 'React Hooks',                                href:'https://reactjs.org/docs/hooks-intro.html'                           },{ name: 'Context API',                                href:'https://reactjs.org/docs/context.html'                               },{ name: 'Javascript',                                 href:'https://developer.mozilla.org/en-US/docs/Web/JavaScript'             },
    ...
    <div className="about">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a target="_blank" href={about[6].href}>{about[6].name}</a></li>
          <li><a target="_blank" href={about[7].href}>{about[7].name}</a></li>            
        </ul>  
      </div> 

      <p>
          <span>Source Code: </span>
          <a target="_blank" href={about[8].href}>{about[8].name}</a>
      </p>
      
      <span>Other games: </span>            
      <ul>
        <li>
          <a target="_blank" href={about[9].href}>{about[9].name}</a>
        </li>
      </ul>    
